...
namespace GtfSharp
{
    internal class GtfSharp
    {
        private static void Main(string[] args)
        {
            ...
            string customGeneModelPath = @"/mnt/d/samantha_debug/test/lib/Genome/GRCh38.96.gtf";
            string referenceGenome = @"/mnt/d/samantha_debug/test/lib/Genome/GRCh38.fa";
            string referenceGeneModel = @"/mnt/d/samantha_debug/test/lib/Genome/GRCh38.96.gff3";
            ...
            {
                customGeneModelPath = p.Object.CustomGeneModel;
                referenceGenome = p.Object.ReferenceGenome;
                referenceGeneModel = p.Object.ReferenceGeneModel;
            }
            FilterGtfEntriesWithoutStrand(customGeneModelPath, referenceGenome, referenceGeneModel);
        }
