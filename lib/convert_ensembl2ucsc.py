#A. Cesnik
#(https://github.com/acesnik/LncRNADiscovery/blob/master/scripts/convert_ensembl2ucsc.py)

#minor edit by Samantha Shrum 2021.8.5
#added lib folder to filepath for my snakemake implementation
...
ensembl2ucsc={}
for line in open("lib/ChromosomeMappings/GRCh38_ensembl2UCSC.txt"):
